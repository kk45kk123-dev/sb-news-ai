...

{
  ...
  "tags": ["짧은 태그 2~4개"],
  "glossary": [{"term": "용어", "definition": "쉬운 설명 (한두 문장)", "context": "이 기사에서 쓰인 맥락 한 문장 (선택, 없으면 생략)"}],
  "importance": "1~5 정수",
...
- glossary: "어려운 단어"가 아니라 이 기사를 이해하는 데 **금융·경제 전문지식이 필요한 용어**만
  최대 5개까지 뽑으세요 — 저축은행 업계 용어로 국한하지 말고 본문에 실제로 나온 용어 중
  다음 분야에 해당하는 것만: 금융시장/경제정책/금융회사 업무/투자·증권/은행·저축은행/거시경제/
  금융상품·규제 관련 전문용어 (예: FCF, Capex, 하이퍼스케일러, 주주환원, 배당수익률, 기준금리,
  DSR, LTV, BIS비율, PF, 예대마진, 유동성, 지급여력, 여신, 수신). "전망", "증가", "감소", "투자",
  "시장", "기업", "성장", "전략", "은행", "대출", "이자", "세금"처럼 배경지식 없이도 문맥으로
  뜻을 알 수 있는 일반 단어는 절대 넣지 마세요. definition은 금융경제 초보자 대상으로, 사전적
  정의를 그대로 옮기지 말고 쉽게 풀어 한두 문장으로 쓰세요. context(선택)에는 이 기사에서 그
  용어가 쓰인 맥락을 한 문장으로 — 채울 내용이 마땅치 않으면 생략하세요. 핵심 용어 위주로
  적게 뽑는 것이 낫습니다. 위 기준에 맞는 전문용어가 하나도 없는 기사는 드뭅니다 — 정말
  없을 때만 빈 배열로 두세요.
