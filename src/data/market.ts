...
// 2026-08-06 기준 확인된 실제 일정으로 채운 값이다 — 외부에 무료 실시간 캘린더 API가
// 없어(유료 서비스만 존재) 시장 지표처럼 자동 갱신은 못 하고, 주기적으로 직접 갱신해야
// 최신 상태가 유지된다. 각 항목의 근거:
// - 미국 7월 고용지표(비농업고용지표): BLS 발표 일정(8/7 08:30 ET)
...
export const ECONOMIC_CALENDAR: EconomicEvent[] = [
  { id: "e1", date: "08.07", time: "21:30", title: "미국 7월 비농업고용지표 발표", importance: "high" },
  { id: "e2", date: "08.27", time: "09:00", title: "한국은행 금융통화위원회 통화정책방향 결정회의", importance: "high" },
  { id: "e3", date: "08.30", time: "-", title: "저축은행 2026년 반기 경영공시 마감", importance: "medium" },
